...
class Fixture {
	...
	private void buildConfig() {
		...
		TeleportedModeParams walkModeRoutingParams = new TeleportedModeParams(TransportMode.walk);
		walkModeRoutingParams.setBeelineDistanceFactor(1.0);
		walkModeRoutingParams.setTeleportedModeSpeed(5.0);
		config.routing().addTeleportedModeParams(walkModeRoutingParams);

		TeleportedModeParams ptModeRoutingParams = new TeleportedModeParams(TransportMode.pt);
		ptModeRoutingParams.setBeelineDistanceFactor(1.0);
		ptModeRoutingParams.setTeleportedModeSpeed(5.0);
		config.routing().addTeleportedModeParams(ptModeRoutingParams);

		TeleportedModeParams drtModeRoutingParams = new TeleportedModeParams(TransportMode.drt);
		drtModeRoutingParams.setBeelineDistanceFactor(1.0);
		drtModeRoutingParams.setTeleportedModeSpeed(5.0);
		config.routing().addTeleportedModeParams(drtModeRoutingParams);
